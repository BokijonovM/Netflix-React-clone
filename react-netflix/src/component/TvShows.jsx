...
<Row>
    ...
    <a className="dropdown-item" href="#">Romance</a>
        ...
        <Col className="d-inline-block ">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="icon1" width="16" height="16" fill="white" className="mt-n2 bi bi-list-nested" viewBox="0 0 16 16">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="icon2" width="16" height="16" fill="white" className="mt-n2 bi bi-grid-fill" viewBox="0 0 16 16">
